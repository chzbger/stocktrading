package com.example.stocktrading.user.application.service;
...
public class UserService implements UserUseCase {
    ...
    @Override
    public void updateNotificationSettings(Long userId, boolean enabled, String botToken, String chatId) {
        User user = userPort.findById(userId)
                .orElseThrow(() -> new CustomBadRequestException("User not found"));
